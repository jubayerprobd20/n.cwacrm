...
//
// Every delivery carries an `X-NCWaCRM-Signature` header so receivers
// can verify the request really came from N.C WaCRM and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-NCWaCRM-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-NCWaCRM-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a N.C WaCRM-to-N.C WaCRM integration
