...
export default function PipelinesPage() {
  ...
  const seedDefaultPipeline = useCallback(async (): Promise<Pipeline | null> => {
    ...
    const { data: pipeline, error } = await supabase
      .from("pipelines")
      .insert({ user_id: user.id, account_id: accountId, organization_id: accountId, name: "Sales Pipeline" })
      .select()
      .single();
  ...
  async function handleCreatePipeline() {
    ...
    const { data: pipeline, error } = await supabase
      .from("pipelines")
      .insert({ user_id: user.id, account_id: accountId, organization_id: accountId, name })
      .select()
      .single();
