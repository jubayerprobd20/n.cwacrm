...
export async function POST(request: Request) {
  ...
  // Process directly and await completion before returning 200 OK.
  // Note: after() does NOT work on Vercel Hobby/Pro free tier for background tasks.
  // We process synchronously to guarantee message persistence.
  try {
