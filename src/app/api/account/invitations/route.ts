...
//   on the list falls through to the nextcorebd.com fallback with a
...
//
// Previous implementation hard-defaulted to `https://nextcorebd.com`
...
function getBaseUrl(request: Request): string {
  ...
  return "https://wacrm.nextcorebd.com";
}
